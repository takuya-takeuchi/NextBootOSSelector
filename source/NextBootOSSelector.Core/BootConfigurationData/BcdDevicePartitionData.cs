...
namespace Ouranos.NextBootOSSelector.BootConfigurationData {
    ...
    // WMI クラス用に生成された事前バインディング クラスです。BcdDevicePartitionData
    internal class BcdDevicePartitionData : Component {
        ...
        private static string CreatedClassName = "BcdDevicePartitionData";
        ...
        public BcdDevicePartitionData() {
            this.InitializeObject(null, null, null);
        }
        
        public BcdDevicePartitionData(ManagementPath path, ObjectGetOptions getOptions) {
            this.InitializeObject(null, path, getOptions);
        }
        
        public BcdDevicePartitionData(ManagementScope mgmtScope, ManagementPath path) {
            this.InitializeObject(mgmtScope, path, null);
        }
        
        public BcdDevicePartitionData(ManagementPath path) {
            this.InitializeObject(null, path, null);
        }
        
        public BcdDevicePartitionData(ManagementScope mgmtScope, ManagementPath path, ObjectGetOptions getOptions) {
            this.InitializeObject(mgmtScope, path, getOptions);
        }
        
        public BcdDevicePartitionData(ManagementObject theObject) {
            this.Initialize();
        ...
        public BcdDevicePartitionData(ManagementBaseObject theObject) {
            this.Initialize();
            if (this.CheckIfProperClass(theObject)) {
        ...
        private static string ConstructPath() {
            string strPath = "root\\WMI:BcdDevicePartitionData";
            return strPath;
        }
        ...
        public static BcdDevicePartitionDataCollection GetInstances() {
            return GetInstances(null, null, null);
        }
        
        public static BcdDevicePartitionDataCollection GetInstances(string condition) {
            return GetInstances(null, condition, null);
        }
        
        public static BcdDevicePartitionDataCollection GetInstances(string[] selectedProperties) {
            return GetInstances(null, null, selectedProperties);
        }
        
        public static BcdDevicePartitionDataCollection GetInstances(string condition, string[] selectedProperties) {
            return GetInstances(null, condition, selectedProperties);
        }
        
        public static BcdDevicePartitionDataCollection GetInstances(ManagementScope mgmtScope, EnumerationOptions enumOptions) {
            if ((mgmtScope == null)) {
            ...
            pathObj.ClassName = "BcdDevicePartitionData";
            ...
            return new BcdDevicePartitionDataCollection(clsObject.GetInstances(enumOptions));
        }
        
        public static BcdDevicePartitionDataCollection GetInstances(ManagementScope mgmtScope, string condition) {
            return GetInstances(mgmtScope, condition, null);
        }
        
        public static BcdDevicePartitionDataCollection GetInstances(ManagementScope mgmtScope, string[] selectedProperties) {
            return GetInstances(mgmtScope, null, selectedProperties);
        }
        
        public static BcdDevicePartitionDataCollection GetInstances(ManagementScope mgmtScope, string condition, string[] selectedProperties) {
            if ((mgmtScope == null)) {
                if ((statMgmtScope == null)) {
                    mgmtScope = new ManagementScope();
                    mgmtScope.Path.NamespacePath = "root\\WMI";
            ...
            ManagementObjectSearcher ObjectSearcher = new ManagementObjectSearcher(mgmtScope, new SelectQuery("BcdDevicePartitionData", condition, selectedProperties));
            EnumerationOptions enumOptions = new EnumerationOptions();
            enumOptions.EnsureLocatable = true;
            ObjectSearcher.Options = enumOptions;
            return new BcdDevicePartitionDataCollection(ObjectSearcher.Get());
        }
        
        [Browsable(true)]
        public static BcdDevicePartitionData CreateInstance() {
            ...
            return new BcdDevicePartitionData(tmpMgmtClass.CreateInstance());
        }
        ...
        internal class BcdDevicePartitionDataCollection : object, ICollection {
            
            private ManagementObjectCollection privColObj;
            
            public BcdDevicePartitionDataCollection(ManagementObjectCollection objCollection) {
            ...
            public virtual void CopyTo(System.Array array, int index) {
                ...
                for (nCtr = 0; (nCtr < array.Length); nCtr = (nCtr + 1)) {
                    array.SetValue(new BcdDevicePartitionData(((ManagementObject)(array.GetValue(nCtr)))), nCtr);
                }
            }
            
            public virtual IEnumerator GetEnumerator() {
                return new BcdDevicePartitionDataEnumerator(this.privColObj.GetEnumerator());
            }
            
            internal class BcdDevicePartitionDataEnumerator : object, IEnumerator {
                
                private ManagementObjectCollection.ManagementObjectEnumerator privObjEnum;
                
                public BcdDevicePartitionDataEnumerator(ManagementObjectCollection.ManagementObjectEnumerator objEnum) {
                    this.privObjEnum = objEnum;
                }
                
                public virtual object Current {
                    get {
                        return new BcdDevicePartitionData(((ManagementObject)(this.privObjEnum.Current)));
                    }
                }
