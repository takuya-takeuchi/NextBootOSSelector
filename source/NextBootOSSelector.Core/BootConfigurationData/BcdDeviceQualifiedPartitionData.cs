...
namespace Ouranos.NextBootOSSelector.BootConfigurationData {
    ...
    // WMI クラス用に生成された事前バインディング クラスです。BcdDeviceQualifiedPartitionData
    internal class BcdDeviceQualifiedPartitionData : Component {
        ...
        private static string CreatedClassName = "BcdDeviceQualifiedPartitionData";
        ...
        public BcdDeviceQualifiedPartitionData() {
            this.InitializeObject(null, null, null);
        }
        
        public BcdDeviceQualifiedPartitionData(ManagementPath path, ObjectGetOptions getOptions) {
            this.InitializeObject(null, path, getOptions);
        }
        
        public BcdDeviceQualifiedPartitionData(ManagementScope mgmtScope, ManagementPath path) {
            this.InitializeObject(mgmtScope, path, null);
        }
        
        public BcdDeviceQualifiedPartitionData(ManagementPath path) {
            this.InitializeObject(null, path, null);
        }
        
        public BcdDeviceQualifiedPartitionData(ManagementScope mgmtScope, ManagementPath path, ObjectGetOptions getOptions) {
            this.InitializeObject(mgmtScope, path, getOptions);
        }
        
        public BcdDeviceQualifiedPartitionData(ManagementObject theObject) {
            this.Initialize();
        ...
        public BcdDeviceQualifiedPartitionData(ManagementBaseObject theObject) {
            this.Initialize();
            if (this.CheckIfProperClass(theObject)) {
        ...
        public string AdditionalOptions {
            get {
                return ((string)(this.curObj["AdditionalOptions"]));
            }
            set {
                this.curObj["AdditionalOptions"] = value;
                if (((this.isEmbedded == false) 
                            && this.AutoCommitProp)) {
        ...
        public bool IsDeviceTypeNull {
            get
            {
                if ((this.curObj["DeviceType"] == null)) {
                    return true;
                }
                return false;
            }
        ...
        public uint DeviceType {
            get {
                ...
                return ((uint)(this.curObj["DeviceType"]));
            }
            set {
                this.curObj["DeviceType"] = value;
                if (((this.isEmbedded == false) 
                            && this.AutoCommitProp)) {
                    this.PrivateLateBoundObject.Put();
                }
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("This is the disk signature.")]
        public string DiskSignature {
            get {
                return ((string)(this.curObj["DiskSignature"]));
            }
            set {
                this.curObj["DiskSignature"] = value;
                if (((this.isEmbedded == false) 
                            && this.AutoCommitProp)) {
                    this.PrivateLateBoundObject.Put();
                }
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("This is the partition identifier.")]
        public string PartitionIdentifier {
            get {
                return ((string)(this.curObj["PartitionIdentifier"]));
            }
            set {
                this.curObj["PartitionIdentifier"] = value;
                if (((this.isEmbedded == false) 
                            && this.AutoCommitProp)) {
                    this.PrivateLateBoundObject.Put();
                }
        ...
        public bool IsPartitionStyleNull {
            get
            {
                if ((this.curObj["PartitionStyle"] == null)) {
                    return true;
                }
                return false;
            }
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("This is the type of partition, MBR or GPT..")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        public PartitionStyleValues PartitionStyle {
            get {
                if ((this.curObj["PartitionStyle"] == null)) {
                    return ((PartitionStyleValues)(System.Convert.ToInt32(2)));
                }
                return ((PartitionStyleValues)(System.Convert.ToInt32(this.curObj["PartitionStyle"])));
            }
            set {
                if ((PartitionStyleValues.NULL_ENUM_VALUE == value)) {
                    this.curObj["PartitionStyle"] = null;
                }
                else {
                    this.curObj["PartitionStyle"] = value;
                }
                if (((this.isEmbedded == false) 
                            && this.AutoCommitProp)) {
                    this.PrivateLateBoundObject.Put();
        ...
        private void ResetAdditionalOptions() {
            this.curObj["AdditionalOptions"] = null;
            if (((this.isEmbedded == false) 
                        && this.AutoCommitProp)) {
                this.PrivateLateBoundObject.Put();
            }
        ...
        private bool ShouldSerializeDeviceType() {
            if ((this.IsDeviceTypeNull == false)) {
                return true;
            }
            return false;
        }
        ...
        private void ResetDiskSignature() {
            this.curObj["DiskSignature"] = null;
            if (((this.isEmbedded == false) 
                        && this.AutoCommitProp)) {
                this.PrivateLateBoundObject.Put();
            }
        ...
        private void ResetPartitionIdentifier() {
            this.curObj["PartitionIdentifier"] = null;
            if (((this.isEmbedded == false) 
                        && this.AutoCommitProp)) {
                this.PrivateLateBoundObject.Put();
            }
        ...
        private void ResetPartitionStyle() {
            this.curObj["PartitionStyle"] = null;
            if (((this.isEmbedded == false) 
                        && this.AutoCommitProp)) {
                this.PrivateLateBoundObject.Put();
        ...
        private static string ConstructPath() {
            string strPath = "root\\WMI:BcdDeviceQualifiedPartitionData";
            return strPath;
        }
        ...
        public static BcdDeviceQualifiedPartitionDataCollection GetInstances() {
            return GetInstances(null, null, null);
        }
        
        public static BcdDeviceQualifiedPartitionDataCollection GetInstances(string condition) {
            return GetInstances(null, condition, null);
        }
        
        public static BcdDeviceQualifiedPartitionDataCollection GetInstances(string[] selectedProperties) {
            return GetInstances(null, null, selectedProperties);
        }
        
        public static BcdDeviceQualifiedPartitionDataCollection GetInstances(string condition, string[] selectedProperties) {
            return GetInstances(null, condition, selectedProperties);
        }
        
        public static BcdDeviceQualifiedPartitionDataCollection GetInstances(ManagementScope mgmtScope, EnumerationOptions enumOptions) {
            if ((mgmtScope == null)) {
            ...
            pathObj.ClassName = "BcdDeviceQualifiedPartitionData";
            ...
            return new BcdDeviceQualifiedPartitionDataCollection(clsObject.GetInstances(enumOptions));
        }
        
        public static BcdDeviceQualifiedPartitionDataCollection GetInstances(ManagementScope mgmtScope, string condition) {
            return GetInstances(mgmtScope, condition, null);
        }
        
        public static BcdDeviceQualifiedPartitionDataCollection GetInstances(ManagementScope mgmtScope, string[] selectedProperties) {
            return GetInstances(mgmtScope, null, selectedProperties);
        }
        
        public static BcdDeviceQualifiedPartitionDataCollection GetInstances(ManagementScope mgmtScope, string condition, string[] selectedProperties) {
            if ((mgmtScope == null)) {
                if ((statMgmtScope == null)) {
                    mgmtScope = new ManagementScope();
                    mgmtScope.Path.NamespacePath = "root\\WMI";
            ...
            ManagementObjectSearcher ObjectSearcher = new ManagementObjectSearcher(mgmtScope, new SelectQuery("BcdDeviceQualifiedPartitionData", condition, selectedProperties));
            EnumerationOptions enumOptions = new EnumerationOptions();
            enumOptions.EnsureLocatable = true;
            ObjectSearcher.Options = enumOptions;
            return new BcdDeviceQualifiedPartitionDataCollection(ObjectSearcher.Get());
        }
        
        [Browsable(true)]
        public static BcdDeviceQualifiedPartitionData CreateInstance() {
            ...
            return new BcdDeviceQualifiedPartitionData(tmpMgmtClass.CreateInstance());
        }
        ...
        internal class BcdDeviceQualifiedPartitionDataCollection : object, ICollection {
            
            private ManagementObjectCollection privColObj;
            
            public BcdDeviceQualifiedPartitionDataCollection(ManagementObjectCollection objCollection) {
            ...
            public virtual void CopyTo(System.Array array, int index) {
                ...
                for (nCtr = 0; (nCtr < array.Length); nCtr = (nCtr + 1)) {
                    array.SetValue(new BcdDeviceQualifiedPartitionData(((ManagementObject)(array.GetValue(nCtr)))), nCtr);
                }
            }
            
            public virtual IEnumerator GetEnumerator() {
                return new BcdDeviceQualifiedPartitionDataEnumerator(this.privColObj.GetEnumerator());
            }
            
            internal class BcdDeviceQualifiedPartitionDataEnumerator : object, IEnumerator {
                
                private ManagementObjectCollection.ManagementObjectEnumerator privObjEnum;
                
                public BcdDeviceQualifiedPartitionDataEnumerator(ManagementObjectCollection.ManagementObjectEnumerator objEnum) {
                    this.privObjEnum = objEnum;
                }
                
                public virtual object Current {
                    get {
                        return new BcdDeviceQualifiedPartitionData(((ManagementObject)(this.privObjEnum.Current)));
                    }
                }
