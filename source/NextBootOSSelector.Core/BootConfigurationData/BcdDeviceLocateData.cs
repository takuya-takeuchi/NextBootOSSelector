...
namespace Ouranos.NextBootOSSelector.BootConfigurationData {
    ...
    // WMI クラス用に生成された事前バインディング クラスです。BcdDeviceLocateData
    internal class BcdDeviceLocateData : Component {
        ...
        private static string CreatedClassName = "BcdDeviceLocateData";
        ...
        public BcdDeviceLocateData(ManagementPath path, ObjectGetOptions getOptions) {
            this.InitializeObject(null, path, getOptions);
        }
        
        public BcdDeviceLocateData(ManagementScope mgmtScope, ManagementPath path) {
            this.InitializeObject(mgmtScope, path, null);
        }
        
        public BcdDeviceLocateData(ManagementPath path) {
            this.InitializeObject(null, path, null);
        }
        
        public BcdDeviceLocateData(ManagementScope mgmtScope, ManagementPath path, ObjectGetOptions getOptions) {
            this.InitializeObject(mgmtScope, path, getOptions);
        }
        
        public BcdDeviceLocateData(ManagementObject theObject) {
            this.Initialize();
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("This provides the locate device type.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        public TypeValues Type {
            get {
                if ((this.curObj["Type"] == null)) {
                    return ((TypeValues)(System.Convert.ToInt32(3)));
                }
                return ((TypeValues)(System.Convert.ToInt32(this.curObj["Type"])));
            }
            set {
        ...
        private static string ConstructPath() {
            string strPath = "root\\WMI:BcdDeviceLocateData";
            return strPath;
        }
        ...
        public static BcdDeviceLocateDataCollection GetInstances() {
            return GetInstances(null, null, null);
        }
        
        public static BcdDeviceLocateDataCollection GetInstances(string condition) {
            return GetInstances(null, condition, null);
        }
        
        public static BcdDeviceLocateDataCollection GetInstances(string[] selectedProperties) {
            return GetInstances(null, null, selectedProperties);
        }
        
        public static BcdDeviceLocateDataCollection GetInstances(string condition, string[] selectedProperties) {
            return GetInstances(null, condition, selectedProperties);
        }
        
        public static BcdDeviceLocateDataCollection GetInstances(ManagementScope mgmtScope, EnumerationOptions enumOptions) {
            if ((mgmtScope == null)) {
            ...
            pathObj.ClassName = "BcdDeviceLocateData";
            ...
            return new BcdDeviceLocateDataCollection(clsObject.GetInstances(enumOptions));
        }
        
        public static BcdDeviceLocateDataCollection GetInstances(ManagementScope mgmtScope, string condition) {
            return GetInstances(mgmtScope, condition, null);
        }
        
        public static BcdDeviceLocateDataCollection GetInstances(ManagementScope mgmtScope, string[] selectedProperties) {
            return GetInstances(mgmtScope, null, selectedProperties);
        }
        
        public static BcdDeviceLocateDataCollection GetInstances(ManagementScope mgmtScope, string condition, string[] selectedProperties) {
            if ((mgmtScope == null)) {
                if ((statMgmtScope == null)) {
                    mgmtScope = new ManagementScope();
                    mgmtScope.Path.NamespacePath = "root\\WMI";
            ...
            ManagementObjectSearcher ObjectSearcher = new ManagementObjectSearcher(mgmtScope, new SelectQuery("BcdDeviceLocateData", condition, selectedProperties));
            EnumerationOptions enumOptions = new EnumerationOptions();
            enumOptions.EnsureLocatable = true;
            ObjectSearcher.Options = enumOptions;
            return new BcdDeviceLocateDataCollection(ObjectSearcher.Get());
        }
        
        [Browsable(true)]
        public static BcdDeviceLocateData CreateInstance() {
            ...
            return new BcdDeviceLocateData(tmpMgmtClass.CreateInstance());
        }
        ...
        internal class BcdDeviceLocateDataCollection : object, ICollection {
            
            private ManagementObjectCollection privColObj;
            
            public BcdDeviceLocateDataCollection(ManagementObjectCollection objCollection) {
            ...
            public virtual void CopyTo(System.Array array, int index) {
                ...
                for (nCtr = 0; (nCtr < array.Length); nCtr = (nCtr + 1)) {
                    array.SetValue(new BcdDeviceLocateData(((ManagementObject)(array.GetValue(nCtr)))), nCtr);
                }
            }
            
            public virtual IEnumerator GetEnumerator() {
                return new BcdDeviceLocateDataEnumerator(this.privColObj.GetEnumerator());
            }
            
            internal class BcdDeviceLocateDataEnumerator : object, IEnumerator {
                
                private ManagementObjectCollection.ManagementObjectEnumerator privObjEnum;
                
                public BcdDeviceLocateDataEnumerator(ManagementObjectCollection.ManagementObjectEnumerator objEnum) {
                    this.privObjEnum = objEnum;
                }
                
                public virtual object Current {
                    get {
                        return new BcdDeviceLocateData(((ManagementObject)(this.privObjEnum.Current)));
                    }
                }
