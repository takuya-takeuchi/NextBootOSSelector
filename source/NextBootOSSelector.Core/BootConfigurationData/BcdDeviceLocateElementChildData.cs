...
namespace Ouranos.NextBootOSSelector.BootConfigurationData {
    ...
    // 	1. 埋め込みプロパティの WMI クラスのマネージクラスを生成してください。これには MgmtClassGen.exe ツールを使用するかサーバー エクスプローラから取得してください。
    // 	2. 生成クラスの名前空間を加えてください。
    // 	3. プロパティの取得/設定関数を変更してマネージ クラスのインスタンスを返してください。
    // 以下はサンプル コードです。
    // 
    // VB コード
    // 
    ...
    // 
    // 
    // WMI クラス用に生成された事前バインディング クラスです。BcdDeviceLocateElementChildData
    internal class BcdDeviceLocateElementChildData : Component {
        ...
        private static string CreatedClassName = "BcdDeviceLocateElementChildData";
        ...
        public BcdDeviceLocateElementChildData() {
            this.InitializeObject(null, null, null);
        }
        
        public BcdDeviceLocateElementChildData(ManagementPath path, ObjectGetOptions getOptions) {
            this.InitializeObject(null, path, getOptions);
        }
        
        public BcdDeviceLocateElementChildData(ManagementScope mgmtScope, ManagementPath path) {
            this.InitializeObject(mgmtScope, path, null);
        }
        
        public BcdDeviceLocateElementChildData(ManagementPath path) {
            this.InitializeObject(null, path, null);
        }
        
        public BcdDeviceLocateElementChildData(ManagementScope mgmtScope, ManagementPath path, ObjectGetOptions getOptions) {
            this.InitializeObject(mgmtScope, path, getOptions);
        }
        
        public BcdDeviceLocateElementChildData(ManagementObject theObject) {
            this.Initialize();
        ...
        public BcdDeviceLocateElementChildData(ManagementBaseObject theObject) {
            this.Initialize();
            if (this.CheckIfProperClass(theObject)) {
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("This provides the locate device element.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        public uint Element {
            get {
                if ((this.curObj["Element"] == null)) {
                ...
                return ((uint)(this.curObj["Element"]));
            }
            set {
                this.curObj["Element"] = value;
                if (((this.isEmbedded == false) 
                            && this.AutoCommitProp)) {
                    this.PrivateLateBoundObject.Put();
                }
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("This is the parent device of this locate device.")]
        public ManagementBaseObject Parent {
            get {
                return ((ManagementBaseObject)(this.curObj["Parent"]));
            }
            set {
                this.curObj["Parent"] = value;
                if (((this.isEmbedded == false) 
                            && this.AutoCommitProp)) {
                    this.PrivateLateBoundObject.Put();
                }
        ...
        private static string ConstructPath() {
            string strPath = "root\\WMI:BcdDeviceLocateElementChildData";
            return strPath;
        }
        ...
        public static BcdDeviceLocateElementChildDataCollection GetInstances() {
            return GetInstances(null, null, null);
        }
        
        public static BcdDeviceLocateElementChildDataCollection GetInstances(string condition) {
            return GetInstances(null, condition, null);
        }
        
        public static BcdDeviceLocateElementChildDataCollection GetInstances(string[] selectedProperties) {
            return GetInstances(null, null, selectedProperties);
        }
        
        public static BcdDeviceLocateElementChildDataCollection GetInstances(string condition, string[] selectedProperties) {
            return GetInstances(null, condition, selectedProperties);
        }
        
        public static BcdDeviceLocateElementChildDataCollection GetInstances(ManagementScope mgmtScope, EnumerationOptions enumOptions) {
            if ((mgmtScope == null)) {
            ...
            pathObj.ClassName = "BcdDeviceLocateElementChildData";
            ...
            return new BcdDeviceLocateElementChildDataCollection(clsObject.GetInstances(enumOptions));
        }
        
        public static BcdDeviceLocateElementChildDataCollection GetInstances(ManagementScope mgmtScope, string condition) {
            return GetInstances(mgmtScope, condition, null);
        }
        
        public static BcdDeviceLocateElementChildDataCollection GetInstances(ManagementScope mgmtScope, string[] selectedProperties) {
            return GetInstances(mgmtScope, null, selectedProperties);
        }
        
        public static BcdDeviceLocateElementChildDataCollection GetInstances(ManagementScope mgmtScope, string condition, string[] selectedProperties) {
            if ((mgmtScope == null)) {
                if ((statMgmtScope == null)) {
                    mgmtScope = new ManagementScope();
                    mgmtScope.Path.NamespacePath = "root\\WMI";
            ...
            ManagementObjectSearcher ObjectSearcher = new ManagementObjectSearcher(mgmtScope, new SelectQuery("BcdDeviceLocateElementChildData", condition, selectedProperties));
            EnumerationOptions enumOptions = new EnumerationOptions();
            enumOptions.EnsureLocatable = true;
            ObjectSearcher.Options = enumOptions;
            return new BcdDeviceLocateElementChildDataCollection(ObjectSearcher.Get());
        }
        
        [Browsable(true)]
        public static BcdDeviceLocateElementChildData CreateInstance() {
            ...
            return new BcdDeviceLocateElementChildData(tmpMgmtClass.CreateInstance());
        }
        ...
        internal class BcdDeviceLocateElementChildDataCollection : object, ICollection {
            
            private ManagementObjectCollection privColObj;
            
            public BcdDeviceLocateElementChildDataCollection(ManagementObjectCollection objCollection) {
            ...
            public virtual void CopyTo(System.Array array, int index) {
                ...
                for (nCtr = 0; (nCtr < array.Length); nCtr = (nCtr + 1)) {
                    array.SetValue(new BcdDeviceLocateElementChildData(((ManagementObject)(array.GetValue(nCtr)))), nCtr);
                }
            }
            
            public virtual IEnumerator GetEnumerator() {
                return new BcdDeviceLocateElementChildDataEnumerator(this.privColObj.GetEnumerator());
            }
            
            internal class BcdDeviceLocateElementChildDataEnumerator : object, IEnumerator {
                
                private ManagementObjectCollection.ManagementObjectEnumerator privObjEnum;
                
                public BcdDeviceLocateElementChildDataEnumerator(ManagementObjectCollection.ManagementObjectEnumerator objEnum) {
                    this.privObjEnum = objEnum;
                }
                
                public virtual object Current {
                    get {
                        return new BcdDeviceLocateElementChildData(((ManagementObject)(this.privObjEnum.Current)));
                    }
                }
