...
namespace Ouranos.NextBootOSSelector.BootConfigurationData {
    ...
    // WMI クラス用に生成された事前バインディング クラスです。BcdIntegerListElement
    internal class BcdIntegerListElement : Component {
        ...
        private static string CreatedClassName = "BcdIntegerListElement";
        ...
        public BcdIntegerListElement() {
            this.InitializeObject(null, null, null);
        }
        
        public BcdIntegerListElement(ManagementPath path, ObjectGetOptions getOptions) {
            this.InitializeObject(null, path, getOptions);
        }
        
        public BcdIntegerListElement(ManagementScope mgmtScope, ManagementPath path) {
            this.InitializeObject(mgmtScope, path, null);
        }
        
        public BcdIntegerListElement(ManagementPath path) {
            this.InitializeObject(null, path, null);
        }
        
        public BcdIntegerListElement(ManagementScope mgmtScope, ManagementPath path, ObjectGetOptions getOptions) {
            this.InitializeObject(mgmtScope, path, getOptions);
        }
        
        public BcdIntegerListElement(ManagementObject theObject) {
            this.Initialize();
        ...
        public BcdIntegerListElement(ManagementBaseObject theObject) {
            this.Initialize();
            if (this.CheckIfProperClass(theObject)) {
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("This is the array of integer values of the element.")]
        public ulong[] Integers {
            get {
                return ((ulong[])(this.curObj["Integers"]));
            }
            set {
                this.curObj["Integers"] = value;
                if (((this.isEmbedded == false) 
                            && this.AutoCommitProp)) {
        ...
        private static string ConstructPath() {
            string strPath = "root\\WMI:BcdIntegerListElement";
            return strPath;
        }
        ...
        public static BcdIntegerListElementCollection GetInstances() {
            return GetInstances(null, null, null);
        }
        
        public static BcdIntegerListElementCollection GetInstances(string condition) {
            return GetInstances(null, condition, null);
        }
        
        public static BcdIntegerListElementCollection GetInstances(string[] selectedProperties) {
            return GetInstances(null, null, selectedProperties);
        }
        
        public static BcdIntegerListElementCollection GetInstances(string condition, string[] selectedProperties) {
            return GetInstances(null, condition, selectedProperties);
        }
        
        public static BcdIntegerListElementCollection GetInstances(ManagementScope mgmtScope, EnumerationOptions enumOptions) {
            if ((mgmtScope == null)) {
            ...
            pathObj.ClassName = "BcdIntegerListElement";
            ...
            return new BcdIntegerListElementCollection(clsObject.GetInstances(enumOptions));
        }
        
        public static BcdIntegerListElementCollection GetInstances(ManagementScope mgmtScope, string condition) {
            return GetInstances(mgmtScope, condition, null);
        }
        
        public static BcdIntegerListElementCollection GetInstances(ManagementScope mgmtScope, string[] selectedProperties) {
            return GetInstances(mgmtScope, null, selectedProperties);
        }
        
        public static BcdIntegerListElementCollection GetInstances(ManagementScope mgmtScope, string condition, string[] selectedProperties) {
            if ((mgmtScope == null)) {
                if ((statMgmtScope == null)) {
                    mgmtScope = new ManagementScope();
                    mgmtScope.Path.NamespacePath = "root\\WMI";
            ...
            ManagementObjectSearcher ObjectSearcher = new ManagementObjectSearcher(mgmtScope, new SelectQuery("BcdIntegerListElement", condition, selectedProperties));
            EnumerationOptions enumOptions = new EnumerationOptions();
            enumOptions.EnsureLocatable = true;
            ObjectSearcher.Options = enumOptions;
            return new BcdIntegerListElementCollection(ObjectSearcher.Get());
        }
        
        [Browsable(true)]
        public static BcdIntegerListElement CreateInstance() {
            ...
            return new BcdIntegerListElement(tmpMgmtClass.CreateInstance());
        }
        ...
        internal class BcdIntegerListElementCollection : object, ICollection {
            
            private ManagementObjectCollection privColObj;
            
            public BcdIntegerListElementCollection(ManagementObjectCollection objCollection) {
            ...
            public virtual void CopyTo(System.Array array, int index) {
                ...
                for (nCtr = 0; (nCtr < array.Length); nCtr = (nCtr + 1)) {
                    array.SetValue(new BcdIntegerListElement(((ManagementObject)(array.GetValue(nCtr)))), nCtr);
                }
            }
            
            public virtual IEnumerator GetEnumerator() {
                return new BcdIntegerListElementEnumerator(this.privColObj.GetEnumerator());
            }
            
            internal class BcdIntegerListElementEnumerator : object, IEnumerator {
                
                private ManagementObjectCollection.ManagementObjectEnumerator privObjEnum;
                
                public BcdIntegerListElementEnumerator(ManagementObjectCollection.ManagementObjectEnumerator objEnum) {
                    this.privObjEnum = objEnum;
                }
                
                public virtual object Current {
                    get {
                        return new BcdIntegerListElement(((ManagementObject)(this.privObjEnum.Current)));
                    }
                }
