...
namespace Ouranos.NextBootOSSelector.BootConfigurationData {
    ...
    // WMI クラス用に生成された事前バインディング クラスです。BcdDeviceLocateElementData
    internal class BcdDeviceLocateElementData : Component {
        ...
        private static string CreatedClassName = "BcdDeviceLocateElementData";
        ...
        public BcdDeviceLocateElementData() {
            this.InitializeObject(null, null, null);
        }
        
        public BcdDeviceLocateElementData(ManagementPath path, ObjectGetOptions getOptions) {
            this.InitializeObject(null, path, getOptions);
        }
        
        public BcdDeviceLocateElementData(ManagementScope mgmtScope, ManagementPath path) {
            this.InitializeObject(mgmtScope, path, null);
        }
        
        public BcdDeviceLocateElementData(ManagementPath path) {
        ...
        public BcdDeviceLocateElementData(ManagementObject theObject) {
            this.Initialize();
        ...
        public BcdDeviceLocateElementData(ManagementBaseObject theObject) {
            this.Initialize();
            if (this.CheckIfProperClass(theObject)) {
        ...
        private static string ConstructPath() {
            string strPath = "root\\WMI:BcdDeviceLocateElementData";
            return strPath;
        }
        ...
        public static BcdDeviceLocateElementDataCollection GetInstances() {
            return GetInstances(null, null, null);
        }
        
        public static BcdDeviceLocateElementDataCollection GetInstances(string condition) {
            return GetInstances(null, condition, null);
        }
        
        public static BcdDeviceLocateElementDataCollection GetInstances(string[] selectedProperties) {
            return GetInstances(null, null, selectedProperties);
        }
        
        public static BcdDeviceLocateElementDataCollection GetInstances(string condition, string[] selectedProperties) {
            return GetInstances(null, condition, selectedProperties);
        }
        
        public static BcdDeviceLocateElementDataCollection GetInstances(ManagementScope mgmtScope, EnumerationOptions enumOptions) {
            if ((mgmtScope == null)) {
            ...
            pathObj.ClassName = "BcdDeviceLocateElementData";
            ...
            return new BcdDeviceLocateElementDataCollection(clsObject.GetInstances(enumOptions));
        }
        
        public static BcdDeviceLocateElementDataCollection GetInstances(ManagementScope mgmtScope, string condition) {
            return GetInstances(mgmtScope, condition, null);
        }
        
        public static BcdDeviceLocateElementDataCollection GetInstances(ManagementScope mgmtScope, string[] selectedProperties) {
            return GetInstances(mgmtScope, null, selectedProperties);
        }
        
        public static BcdDeviceLocateElementDataCollection GetInstances(ManagementScope mgmtScope, string condition, string[] selectedProperties) {
            if ((mgmtScope == null)) {
                if ((statMgmtScope == null)) {
                    mgmtScope = new ManagementScope();
                    mgmtScope.Path.NamespacePath = "root\\WMI";
            ...
            ManagementObjectSearcher ObjectSearcher = new ManagementObjectSearcher(mgmtScope, new SelectQuery("BcdDeviceLocateElementData", condition, selectedProperties));
            EnumerationOptions enumOptions = new EnumerationOptions();
            enumOptions.EnsureLocatable = true;
            ObjectSearcher.Options = enumOptions;
            return new BcdDeviceLocateElementDataCollection(ObjectSearcher.Get());
        }
        
        [Browsable(true)]
        public static BcdDeviceLocateElementData CreateInstance() {
            ...
            return new BcdDeviceLocateElementData(tmpMgmtClass.CreateInstance());
        }
        ...
        internal class BcdDeviceLocateElementDataCollection : object, ICollection {
            
            private ManagementObjectCollection privColObj;
            
            public BcdDeviceLocateElementDataCollection(ManagementObjectCollection objCollection) {
            ...
            public virtual void CopyTo(System.Array array, int index) {
                ...
                for (nCtr = 0; (nCtr < array.Length); nCtr = (nCtr + 1)) {
                    array.SetValue(new BcdDeviceLocateElementData(((ManagementObject)(array.GetValue(nCtr)))), nCtr);
                }
            }
            
            public virtual IEnumerator GetEnumerator() {
                return new BcdDeviceLocateElementDataEnumerator(this.privColObj.GetEnumerator());
            }
            
            internal class BcdDeviceLocateElementDataEnumerator : object, IEnumerator {
                
                private ManagementObjectCollection.ManagementObjectEnumerator privObjEnum;
                
                public BcdDeviceLocateElementDataEnumerator(ManagementObjectCollection.ManagementObjectEnumerator objEnum) {
                    this.privObjEnum = objEnum;
                }
                
                public virtual object Current {
                    get {
                        return new BcdDeviceLocateElementData(((ManagementObject)(this.privObjEnum.Current)));
                    }
                }
