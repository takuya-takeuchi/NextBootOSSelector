...
namespace Ouranos.NextBootOSSelector.BootConfigurationData {
    ...
    // WMI クラス用に生成された事前バインディング クラスです。BcdDeviceUnknownData
    internal class BcdDeviceUnknownData : Component {
        ...
        private static string CreatedClassName = "BcdDeviceUnknownData";
        ...
        public BcdDeviceUnknownData() {
            this.InitializeObject(null, null, null);
        }
        
        public BcdDeviceUnknownData(ManagementPath path, ObjectGetOptions getOptions) {
            this.InitializeObject(null, path, getOptions);
        }
        
        public BcdDeviceUnknownData(ManagementScope mgmtScope, ManagementPath path) {
            this.InitializeObject(mgmtScope, path, null);
        }
        
        public BcdDeviceUnknownData(ManagementPath path) {
            this.InitializeObject(null, path, null);
        }
        
        public BcdDeviceUnknownData(ManagementScope mgmtScope, ManagementPath path, ObjectGetOptions getOptions) {
        ...
        public BcdDeviceUnknownData(ManagementBaseObject theObject) {
            this.Initialize();
            if (this.CheckIfProperClass(theObject)) {
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("This is the binary data of the unknown device element.")]
        public byte[] Data {
            get {
                return ((byte[])(this.curObj["Data"]));
            }
            set {
                this.curObj["Data"] = value;
                if (((this.isEmbedded == false) 
                            && this.AutoCommitProp)) {
                    this.PrivateLateBoundObject.Put();
                }
        ...
        private static string ConstructPath() {
            string strPath = "root\\WMI:BcdDeviceUnknownData";
            return strPath;
        }
        ...
        public static BcdDeviceUnknownDataCollection GetInstances() {
            return GetInstances(null, null, null);
        }
        
        public static BcdDeviceUnknownDataCollection GetInstances(string condition) {
            return GetInstances(null, condition, null);
        }
        
        public static BcdDeviceUnknownDataCollection GetInstances(string[] selectedProperties) {
            return GetInstances(null, null, selectedProperties);
        }
        
        public static BcdDeviceUnknownDataCollection GetInstances(string condition, string[] selectedProperties) {
            return GetInstances(null, condition, selectedProperties);
        }
        
        public static BcdDeviceUnknownDataCollection GetInstances(ManagementScope mgmtScope, EnumerationOptions enumOptions) {
            if ((mgmtScope == null)) {
            ...
            pathObj.ClassName = "BcdDeviceUnknownData";
            ...
            return new BcdDeviceUnknownDataCollection(clsObject.GetInstances(enumOptions));
        }
        
        public static BcdDeviceUnknownDataCollection GetInstances(ManagementScope mgmtScope, string condition) {
            return GetInstances(mgmtScope, condition, null);
        }
        
        public static BcdDeviceUnknownDataCollection GetInstances(ManagementScope mgmtScope, string[] selectedProperties) {
            return GetInstances(mgmtScope, null, selectedProperties);
        }
        
        public static BcdDeviceUnknownDataCollection GetInstances(ManagementScope mgmtScope, string condition, string[] selectedProperties) {
            if ((mgmtScope == null)) {
                if ((statMgmtScope == null)) {
                    mgmtScope = new ManagementScope();
                    mgmtScope.Path.NamespacePath = "root\\WMI";
            ...
            ManagementObjectSearcher ObjectSearcher = new ManagementObjectSearcher(mgmtScope, new SelectQuery("BcdDeviceUnknownData", condition, selectedProperties));
            EnumerationOptions enumOptions = new EnumerationOptions();
            enumOptions.EnsureLocatable = true;
            ObjectSearcher.Options = enumOptions;
            return new BcdDeviceUnknownDataCollection(ObjectSearcher.Get());
        }
        
        [Browsable(true)]
        public static BcdDeviceUnknownData CreateInstance() {
            ...
            return new BcdDeviceUnknownData(tmpMgmtClass.CreateInstance());
        }
        ...
        internal class BcdDeviceUnknownDataCollection : object, ICollection {
            
            private ManagementObjectCollection privColObj;
            
            public BcdDeviceUnknownDataCollection(ManagementObjectCollection objCollection) {
            ...
            public virtual void CopyTo(System.Array array, int index) {
                ...
                for (nCtr = 0; (nCtr < array.Length); nCtr = (nCtr + 1)) {
                    array.SetValue(new BcdDeviceUnknownData(((ManagementObject)(array.GetValue(nCtr)))), nCtr);
                }
            }
            
            public virtual IEnumerator GetEnumerator() {
                return new BcdDeviceUnknownDataEnumerator(this.privColObj.GetEnumerator());
            }
            
            internal class BcdDeviceUnknownDataEnumerator : object, IEnumerator {
                
                private ManagementObjectCollection.ManagementObjectEnumerator privObjEnum;
                
                public BcdDeviceUnknownDataEnumerator(ManagementObjectCollection.ManagementObjectEnumerator objEnum) {
                    this.privObjEnum = objEnum;
                }
                
                public virtual object Current {
                    get {
                        return new BcdDeviceUnknownData(((ManagementObject)(this.privObjEnum.Current)));
                    }
                }
