...
namespace Ouranos.NextBootOSSelector.BootConfigurationData {
    ...
    // 
    // 
    // WMI クラス用に生成された事前バインディング クラスです。BcdDeviceFileData
    internal class BcdDeviceFileData : Component {
        ...
        private static string CreatedClassName = "BcdDeviceFileData";
        ...
        public BcdDeviceFileData() {
            this.InitializeObject(null, null, null);
        }
        
        public BcdDeviceFileData(ManagementPath path, ObjectGetOptions getOptions) {
            this.InitializeObject(null, path, getOptions);
        }
        
        public BcdDeviceFileData(ManagementScope mgmtScope, ManagementPath path) {
            this.InitializeObject(mgmtScope, path, null);
        }
        
        public BcdDeviceFileData(ManagementPath path) {
            this.InitializeObject(null, path, null);
        }
        
        public BcdDeviceFileData(ManagementScope mgmtScope, ManagementPath path, ObjectGetOptions getOptions) {
            this.InitializeObject(mgmtScope, path, getOptions);
        }
        
        public BcdDeviceFileData(ManagementObject theObject) {
            this.Initialize();
        ...
        public BcdDeviceFileData(ManagementBaseObject theObject) {
            this.Initialize();
            if (this.CheckIfProperClass(theObject)) {
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("This is the parent device of this file device.")]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("This is the device path.")]
        public string Path0 {
            get {
                return ((string)(this.curObj["Path"]));
            }
            set {
                this.curObj["Path"] = value;
                if (((this.isEmbedded == false) 
                            && this.AutoCommitProp)) {
                    this.PrivateLateBoundObject.Put();
                }
        ...
        private static string ConstructPath() {
            string strPath = "root\\WMI:BcdDeviceFileData";
            return strPath;
        }
        ...
        public static BcdDeviceFileDataCollection GetInstances() {
            return GetInstances(null, null, null);
        }
        
        public static BcdDeviceFileDataCollection GetInstances(string condition) {
            return GetInstances(null, condition, null);
        }
        
        public static BcdDeviceFileDataCollection GetInstances(string[] selectedProperties) {
            return GetInstances(null, null, selectedProperties);
        }
        
        public static BcdDeviceFileDataCollection GetInstances(string condition, string[] selectedProperties) {
            return GetInstances(null, condition, selectedProperties);
        }
        
        public static BcdDeviceFileDataCollection GetInstances(ManagementScope mgmtScope, EnumerationOptions enumOptions) {
            if ((mgmtScope == null)) {
            ...
            pathObj.ClassName = "BcdDeviceFileData";
            ...
            return new BcdDeviceFileDataCollection(clsObject.GetInstances(enumOptions));
        }
        
        public static BcdDeviceFileDataCollection GetInstances(ManagementScope mgmtScope, string condition) {
            return GetInstances(mgmtScope, condition, null);
        }
        
        public static BcdDeviceFileDataCollection GetInstances(ManagementScope mgmtScope, string[] selectedProperties) {
            return GetInstances(mgmtScope, null, selectedProperties);
        }
        
        public static BcdDeviceFileDataCollection GetInstances(ManagementScope mgmtScope, string condition, string[] selectedProperties) {
            if ((mgmtScope == null)) {
                if ((statMgmtScope == null)) {
                    mgmtScope = new ManagementScope();
                    mgmtScope.Path.NamespacePath = "root\\WMI";
            ...
            ManagementObjectSearcher ObjectSearcher = new ManagementObjectSearcher(mgmtScope, new SelectQuery("BcdDeviceFileData", condition, selectedProperties));
            EnumerationOptions enumOptions = new EnumerationOptions();
            enumOptions.EnsureLocatable = true;
            ObjectSearcher.Options = enumOptions;
            return new BcdDeviceFileDataCollection(ObjectSearcher.Get());
        }
        
        [Browsable(true)]
        public static BcdDeviceFileData CreateInstance() {
            ...
            return new BcdDeviceFileData(tmpMgmtClass.CreateInstance());
        }
        ...
        internal class BcdDeviceFileDataCollection : object, ICollection {
            
            private ManagementObjectCollection privColObj;
            
            public BcdDeviceFileDataCollection(ManagementObjectCollection objCollection) {
            ...
            public virtual void CopyTo(System.Array array, int index) {
                ...
                for (nCtr = 0; (nCtr < array.Length); nCtr = (nCtr + 1)) {
                    array.SetValue(new BcdDeviceFileData(((ManagementObject)(array.GetValue(nCtr)))), nCtr);
                }
            }
            
            public virtual IEnumerator GetEnumerator() {
                return new BcdDeviceFileDataEnumerator(this.privColObj.GetEnumerator());
            }
            
            internal class BcdDeviceFileDataEnumerator : object, IEnumerator {
                
                private ManagementObjectCollection.ManagementObjectEnumerator privObjEnum;
                
                public BcdDeviceFileDataEnumerator(ManagementObjectCollection.ManagementObjectEnumerator objEnum) {
                    this.privObjEnum = objEnum;
                }
                
                public virtual object Current {
                    get {
                        return new BcdDeviceFileData(((ManagementObject)(this.privObjEnum.Current)));
                    }
                }
