...
namespace Ouranos.NextBootOSSelector.BootConfigurationData {
    ...
    internal class BcdObject : Component {
        ...
        public BcdObject(string keyId, string keyStoreFilePath) {
            this.InitializeObject(null, new ManagementPath(ConstructPath(keyId, keyStoreFilePath)), null);
        }
        
        public BcdObject(ManagementScope mgmtScope, string keyId, string keyStoreFilePath) {
            this.InitializeObject(mgmtScope, new ManagementPath(ConstructPath(keyId, keyStoreFilePath)), null);
        }
        ...
        public static BcdObjectCollection GetInstances(ManagementScope mgmtScope, string condition, string[] selectedProperties) {
            ...
            ManagementObjectSearcher ObjectSearcher = new ManagementObjectSearcher(mgmtScope, new SelectQuery("BcdObject", condition, selectedProperties));
        ...
        public bool DeleteElement(uint Type)
        {
            if ((this.isEmbedded == false)) {
                ...
                inParams = this.PrivateLateBoundObject.GetMethodParameters("DeleteElement");
                inParams["Type"] = Type;
                ManagementBaseObject outParams = this.PrivateLateBoundObject.InvokeMethod("DeleteElement", inParams, null);
        ...
        public bool EnumerateElements(out ManagementBaseObject[] Elements) {
            if ((this.isEmbedded == false)) {
                ManagementBaseObject inParams = null;
                ManagementBaseObject outParams = this.PrivateLateBoundObject.InvokeMethod("EnumerateElements", inParams, null);
        ...
        public bool EnumerateElementTypes(out uint[] Types) {
            if ((this.isEmbedded == false)) {
                ManagementBaseObject inParams = null;
                ManagementBaseObject outParams = this.PrivateLateBoundObject.InvokeMethod("EnumerateElementTypes", inParams, null);
        ...
        public bool GetElement(uint Type, out ManagementBaseObject Element) {
            if ((this.isEmbedded == false)) {
                ManagementBaseObject inParams = null;
                inParams = this.PrivateLateBoundObject.GetMethodParameters("GetElement");
                inParams["Type"] = Type;
                ManagementBaseObject outParams = this.PrivateLateBoundObject.InvokeMethod("GetElement", inParams, null);
        ...
        public bool GetElementWithFlags(uint Flags, uint Type, out ManagementBaseObject Element) {
            if ((this.isEmbedded == false)) {
                ManagementBaseObject inParams = null;
                inParams = this.PrivateLateBoundObject.GetMethodParameters("GetElementWithFlags");
                inParams["Flags"] = Flags;
                inParams["Type"] = Type;
                ManagementBaseObject outParams = this.PrivateLateBoundObject.InvokeMethod("GetElementWithFlags", inParams, null);
                Element = ((ManagementBaseObject)(outParams.Properties["Element"].Value));
                return System.Convert.ToBoolean(outParams.Properties["ReturnValue"].Value);
            }
            Element = null;
        ...
        public bool SetBooleanElement(bool Boolean, uint Type)
        {
            if ((this.isEmbedded == false)) {
                ManagementBaseObject inParams = null;
                inParams = this.PrivateLateBoundObject.GetMethodParameters("SetBooleanElement");
                inParams["Boolean"] = Boolean;
                inParams["Type"] = Type;
                ManagementBaseObject outParams = this.PrivateLateBoundObject.InvokeMethod("SetBooleanElement", inParams, null);
                return System.Convert.ToBoolean(outParams.Properties["ReturnValue"].Value);
            }
            return System.Convert.ToBoolean(0);
        }
        ...
        public bool SetDeviceElement(string AdditionalOptions, uint DeviceType, uint Type)
        {
            if ((this.isEmbedded == false)) {
                ManagementBaseObject inParams = null;
                inParams = this.PrivateLateBoundObject.GetMethodParameters("SetDeviceElement");
                inParams["AdditionalOptions"] = AdditionalOptions;
                inParams["DeviceType"] = DeviceType;
                inParams["Type"] = Type;
                ManagementBaseObject outParams = this.PrivateLateBoundObject.InvokeMethod("SetDeviceElement", inParams, null);
                return System.Convert.ToBoolean(outParams.Properties["ReturnValue"].Value);
            }
            return System.Convert.ToBoolean(0);
        }
        ...
        public bool SetFileDeviceElement(string AdditionalOptions, uint DeviceType, string ParentAdditionalOptions, uint ParentDeviceType, string ParentPath, string Path, uint Type)
        {
            if ((this.isEmbedded == false)) {
                ManagementBaseObject inParams = null;
                inParams = this.PrivateLateBoundObject.GetMethodParameters("SetFileDeviceElement");
                inParams["AdditionalOptions"] = AdditionalOptions;
                inParams["DeviceType"] = DeviceType;
                ...
                inParams["Path"] = Path;
                inParams["Type"] = Type;
                ManagementBaseObject outParams = this.PrivateLateBoundObject.InvokeMethod("SetFileDeviceElement", inParams, null);
                return System.Convert.ToBoolean(outParams.Properties["ReturnValue"].Value);
            }
            return System.Convert.ToBoolean(0);
        }
        ...
        public bool SetIntegerElement(ulong Integer, uint Type)
        {
            if ((this.isEmbedded == false)) {
                ManagementBaseObject inParams = null;
                inParams = this.PrivateLateBoundObject.GetMethodParameters("SetIntegerElement");
                inParams["Integer"] = Integer;
                inParams["Type"] = Type;
                ManagementBaseObject outParams = this.PrivateLateBoundObject.InvokeMethod("SetIntegerElement", inParams, null);
                return System.Convert.ToBoolean(outParams.Properties["ReturnValue"].Value);
            }
            return System.Convert.ToBoolean(0);
        }
        ...
        public bool SetIntegerListElement(ulong[] Integers, uint Type)
        {
            if ((this.isEmbedded == false)) {
                ManagementBaseObject inParams = null;
                inParams = this.PrivateLateBoundObject.GetMethodParameters("SetIntegerListElement");
                inParams["Integers"] = Integers;
                inParams["Type"] = Type;
                ManagementBaseObject outParams = this.PrivateLateBoundObject.InvokeMethod("SetIntegerListElement", inParams, null);
                return System.Convert.ToBoolean(outParams.Properties["ReturnValue"].Value);
            }
            return System.Convert.ToBoolean(0);
        }
        ...
        public bool SetObjectElement(string Id, uint Type)
        {
            if ((this.isEmbedded == false)) {
                ManagementBaseObject inParams = null;
                inParams = this.PrivateLateBoundObject.GetMethodParameters("SetObjectElement");
                inParams["Id"] = Id;
                inParams["Type"] = Type;
                ManagementBaseObject outParams = this.PrivateLateBoundObject.InvokeMethod("SetObjectElement", inParams, null);
                return System.Convert.ToBoolean(outParams.Properties["ReturnValue"].Value);
            }
            return System.Convert.ToBoolean(0);
        }
        ...
        public bool SetObjectListElement(string[] Ids, uint Type)
        {
            if ((this.isEmbedded == false)) {
                ManagementBaseObject inParams = null;
                inParams = this.PrivateLateBoundObject.GetMethodParameters("SetObjectListElement");
                inParams["Ids"] = Ids;
                inParams["Type"] = Type;
                ManagementBaseObject outParams = this.PrivateLateBoundObject.InvokeMethod("SetObjectListElement", inParams, null);
                return System.Convert.ToBoolean(outParams.Properties["ReturnValue"].Value);
            }
            return System.Convert.ToBoolean(0);
        }
        ...
        public bool SetPartitionDeviceElement(string AdditionalOptions, uint DeviceType, string Path, uint Type)
        {
            if ((this.isEmbedded == false)) {
                ManagementBaseObject inParams = null;
                inParams = this.PrivateLateBoundObject.GetMethodParameters("SetPartitionDeviceElement");
                inParams["AdditionalOptions"] = AdditionalOptions;
                inParams["DeviceType"] = DeviceType;
                inParams["Path"] = Path;
                inParams["Type"] = Type;
                ManagementBaseObject outParams = this.PrivateLateBoundObject.InvokeMethod("SetPartitionDeviceElement", inParams, null);
                return System.Convert.ToBoolean(outParams.Properties["ReturnValue"].Value);
            }
            return System.Convert.ToBoolean(0);
        }
        ...
        public bool SetPartitionDeviceElementWithFlags(string AdditionalOptions, uint DeviceType, uint Flags, string Path, uint Type)
        {
            if ((this.isEmbedded == false)) {
                ManagementBaseObject inParams = null;
                inParams = this.PrivateLateBoundObject.GetMethodParameters("SetPartitionDeviceElementWithFlags");
                inParams["AdditionalOptions"] = AdditionalOptions;
                inParams["DeviceType"] = DeviceType;
                inParams["Flags"] = Flags;
                inParams["Path"] = Path;
                inParams["Type"] = Type;
                ManagementBaseObject outParams = this.PrivateLateBoundObject.InvokeMethod("SetPartitionDeviceElementWithFlags", inParams, null);
                return System.Convert.ToBoolean(outParams.Properties["ReturnValue"].Value);
            }
            return System.Convert.ToBoolean(0);
        }
        ...
        public bool SetQualifiedPartitionDeviceElement(string DiskSignature, string PartitionIdentifier, uint PartitionStyle, uint Type)
        {
            if ((this.isEmbedded == false)) {
                ManagementBaseObject inParams = null;
                inParams = this.PrivateLateBoundObject.GetMethodParameters("SetQualifiedPartitionDeviceElement");
                ...
                inParams["Type"] = Type;
                ManagementBaseObject outParams = this.PrivateLateBoundObject.InvokeMethod("SetQualifiedPartitionDeviceElement", inParams, null);
                return System.Convert.ToBoolean(outParams.Properties["ReturnValue"].Value);
            }
            return System.Convert.ToBoolean(0);
        }
        ...
        public bool SetStringElement(string String, uint Type)
        {
            if ((this.isEmbedded == false)) {
                ManagementBaseObject inParams = null;
                inParams = this.PrivateLateBoundObject.GetMethodParameters("SetStringElement");
                inParams["String"] = String;
                inParams["Type"] = Type;
                ManagementBaseObject outParams = this.PrivateLateBoundObject.InvokeMethod("SetStringElement", inParams, null);
                return System.Convert.ToBoolean(outParams.Properties["ReturnValue"].Value);
            }
            return System.Convert.ToBoolean(0);
        }
        ...
        public bool SetVhdDeviceElement(uint CustomLocate, string ParentAdditionalOptions, uint ParentDeviceType, string ParentPath, string Path, uint Type)
        {
            if ((this.isEmbedded == false)) {
                ManagementBaseObject inParams = null;
                inParams = this.PrivateLateBoundObject.GetMethodParameters("SetVhdDeviceElement");
                ...
                inParams["Path"] = Path;
                inParams["Type"] = Type;
                ManagementBaseObject outParams = this.PrivateLateBoundObject.InvokeMethod("SetVhdDeviceElement", inParams, null);
                return System.Convert.ToBoolean(outParams.Properties["ReturnValue"].Value);
            }
            return System.Convert.ToBoolean(0);
        }
        ...
        internal class BcdObjectCollection : object, ICollection {
            ...
            public virtual IEnumerator GetEnumerator() {
                return new BcdObjectEnumerator(this.privColObj.GetEnumerator());
            }
            
            internal class BcdObjectEnumerator : object, IEnumerator {
                ...
                public virtual object Current {
                    get {
                        return new BcdObject(((ManagementObject)(this.privObjEnum.Current)));
                    }
                }
