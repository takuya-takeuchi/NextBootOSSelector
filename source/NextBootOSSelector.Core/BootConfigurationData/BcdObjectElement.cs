...
namespace Ouranos.NextBootOSSelector.BootConfigurationData {
    ...
    // WMI クラス用に生成された事前バインディング クラスです。BcdObjectElement
    internal class BcdObjectElement : Component {
        ...
        private static string CreatedClassName = "BcdObjectElement";
        ...
        public BcdObjectElement() {
            this.InitializeObject(null, null, null);
        }
        
        public BcdObjectElement(ManagementPath path, ObjectGetOptions getOptions) {
            this.InitializeObject(null, path, getOptions);
        }
        
        public BcdObjectElement(ManagementScope mgmtScope, ManagementPath path) {
            this.InitializeObject(mgmtScope, path, null);
        }
        
        public BcdObjectElement(ManagementPath path) {
            this.InitializeObject(null, path, null);
        }
        
        public BcdObjectElement(ManagementScope mgmtScope, ManagementPath path, ObjectGetOptions getOptions) {
            this.InitializeObject(mgmtScope, path, getOptions);
        }
        
        public BcdObjectElement(ManagementObject theObject) {
            this.Initialize();
        ...
        public BcdObjectElement(ManagementBaseObject theObject) {
            this.Initialize();
            if (this.CheckIfProperClass(theObject)) {
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("This is the guid id of the object this element refers to.")]
        public string Id {
            get {
                return ((string)(this.curObj["Id"]));
            }
            set {
                this.curObj["Id"] = value;
                if (((this.isEmbedded == false) 
                            && this.AutoCommitProp)) {
        ...
        private static string ConstructPath() {
            string strPath = "root\\WMI:BcdObjectElement";
            return strPath;
        }
        ...
        public static BcdObjectElementCollection GetInstances() {
            return GetInstances(null, null, null);
        }
        
        public static BcdObjectElementCollection GetInstances(string condition) {
            return GetInstances(null, condition, null);
        }
        
        public static BcdObjectElementCollection GetInstances(string[] selectedProperties) {
            return GetInstances(null, null, selectedProperties);
        }
        
        public static BcdObjectElementCollection GetInstances(string condition, string[] selectedProperties) {
            return GetInstances(null, condition, selectedProperties);
        }
        
        public static BcdObjectElementCollection GetInstances(ManagementScope mgmtScope, EnumerationOptions enumOptions) {
            if ((mgmtScope == null)) {
            ...
            pathObj.ClassName = "BcdObjectElement";
            ...
            return new BcdObjectElementCollection(clsObject.GetInstances(enumOptions));
        }
        
        public static BcdObjectElementCollection GetInstances(ManagementScope mgmtScope, string condition) {
            return GetInstances(mgmtScope, condition, null);
        }
        
        public static BcdObjectElementCollection GetInstances(ManagementScope mgmtScope, string[] selectedProperties) {
            return GetInstances(mgmtScope, null, selectedProperties);
        }
        
        public static BcdObjectElementCollection GetInstances(ManagementScope mgmtScope, string condition, string[] selectedProperties) {
            if ((mgmtScope == null)) {
                if ((statMgmtScope == null)) {
                    mgmtScope = new ManagementScope();
                    mgmtScope.Path.NamespacePath = "root\\WMI";
            ...
            ManagementObjectSearcher ObjectSearcher = new ManagementObjectSearcher(mgmtScope, new SelectQuery("BcdObjectElement", condition, selectedProperties));
            EnumerationOptions enumOptions = new EnumerationOptions();
            enumOptions.EnsureLocatable = true;
            ObjectSearcher.Options = enumOptions;
            return new BcdObjectElementCollection(ObjectSearcher.Get());
        }
        
        [Browsable(true)]
        public static BcdObjectElement CreateInstance() {
            ...
            return new BcdObjectElement(tmpMgmtClass.CreateInstance());
        }
        ...
        internal class BcdObjectElementCollection : object, ICollection {
            
            private ManagementObjectCollection privColObj;
            
            public BcdObjectElementCollection(ManagementObjectCollection objCollection) {
            ...
            public virtual void CopyTo(System.Array array, int index) {
                ...
                for (nCtr = 0; (nCtr < array.Length); nCtr = (nCtr + 1)) {
                    array.SetValue(new BcdObjectElement(((ManagementObject)(array.GetValue(nCtr)))), nCtr);
                }
            }
            
            public virtual IEnumerator GetEnumerator() {
                return new BcdObjectElementEnumerator(this.privColObj.GetEnumerator());
            }
            
            internal class BcdObjectElementEnumerator : object, IEnumerator {
                
                private ManagementObjectCollection.ManagementObjectEnumerator privObjEnum;
                
                public BcdObjectElementEnumerator(ManagementObjectCollection.ManagementObjectEnumerator objEnum) {
                    this.privObjEnum = objEnum;
                }
                
                public virtual object Current {
                    get {
                        return new BcdObjectElement(((ManagementObject)(this.privObjEnum.Current)));
                    }
                }
