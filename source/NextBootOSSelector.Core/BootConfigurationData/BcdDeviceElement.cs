...
namespace Ouranos.NextBootOSSelector.BootConfigurationData {
    ...
    // 
    // 
    // WMI クラス用に生成された事前バインディング クラスです。BcdDeviceElement
    internal class BcdDeviceElement : Component {
        ...
        private static string CreatedClassName = "BcdDeviceElement";
        ...
        public BcdDeviceElement() {
            this.InitializeObject(null, null, null);
        }
        
        public BcdDeviceElement(ManagementPath path, ObjectGetOptions getOptions) {
            this.InitializeObject(null, path, getOptions);
        }
        
        public BcdDeviceElement(ManagementScope mgmtScope, ManagementPath path) {
            this.InitializeObject(mgmtScope, path, null);
        }
        
        public BcdDeviceElement(ManagementPath path) {
            this.InitializeObject(null, path, null);
        }
        
        public BcdDeviceElement(ManagementScope mgmtScope, ManagementPath path, ObjectGetOptions getOptions) {
            this.InitializeObject(mgmtScope, path, getOptions);
        }
        
        public BcdDeviceElement(ManagementObject theObject) {
            this.Initialize();
        ...
        public BcdDeviceElement(ManagementBaseObject theObject) {
            this.Initialize();
            if (this.CheckIfProperClass(theObject)) {
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("This field contains information about the device.")]
        public ManagementBaseObject Device {
            get {
                return ((ManagementBaseObject)(this.curObj["Device"]));
            }
            set {
                this.curObj["Device"] = value;
                if (((this.isEmbedded == false) 
                            && this.AutoCommitProp)) {
        ...
        private static string ConstructPath() {
            string strPath = "root\\WMI:BcdDeviceElement";
            return strPath;
        }
        ...
        public static BcdDeviceElementCollection GetInstances() {
            return GetInstances(null, null, null);
        }
        
        public static BcdDeviceElementCollection GetInstances(string condition) {
            return GetInstances(null, condition, null);
        }
        
        public static BcdDeviceElementCollection GetInstances(string[] selectedProperties) {
            return GetInstances(null, null, selectedProperties);
        }
        
        public static BcdDeviceElementCollection GetInstances(string condition, string[] selectedProperties) {
            return GetInstances(null, condition, selectedProperties);
        }
        
        public static BcdDeviceElementCollection GetInstances(ManagementScope mgmtScope, EnumerationOptions enumOptions) {
            if ((mgmtScope == null)) {
            ...
            pathObj.ClassName = "BcdDeviceElement";
            ...
            return new BcdDeviceElementCollection(clsObject.GetInstances(enumOptions));
        }
        
        public static BcdDeviceElementCollection GetInstances(ManagementScope mgmtScope, string condition) {
            return GetInstances(mgmtScope, condition, null);
        }
        
        public static BcdDeviceElementCollection GetInstances(ManagementScope mgmtScope, string[] selectedProperties) {
            return GetInstances(mgmtScope, null, selectedProperties);
        }
        
        public static BcdDeviceElementCollection GetInstances(ManagementScope mgmtScope, string condition, string[] selectedProperties) {
            if ((mgmtScope == null)) {
                if ((statMgmtScope == null)) {
                    mgmtScope = new ManagementScope();
                    mgmtScope.Path.NamespacePath = "root\\WMI";
            ...
            ManagementObjectSearcher ObjectSearcher = new ManagementObjectSearcher(mgmtScope, new SelectQuery("BcdDeviceElement", condition, selectedProperties));
            EnumerationOptions enumOptions = new EnumerationOptions();
            enumOptions.EnsureLocatable = true;
            ObjectSearcher.Options = enumOptions;
            return new BcdDeviceElementCollection(ObjectSearcher.Get());
        }
        
        [Browsable(true)]
        public static BcdDeviceElement CreateInstance() {
            ...
            return new BcdDeviceElement(tmpMgmtClass.CreateInstance());
        }
        ...
        internal class BcdDeviceElementCollection : object, ICollection {
            
            private ManagementObjectCollection privColObj;
            
            public BcdDeviceElementCollection(ManagementObjectCollection objCollection) {
            ...
            public virtual void CopyTo(System.Array array, int index) {
                ...
                for (nCtr = 0; (nCtr < array.Length); nCtr = (nCtr + 1)) {
                    array.SetValue(new BcdDeviceElement(((ManagementObject)(array.GetValue(nCtr)))), nCtr);
                }
            }
            
            public virtual IEnumerator GetEnumerator() {
                return new BcdDeviceElementEnumerator(this.privColObj.GetEnumerator());
            }
            
            internal class BcdDeviceElementEnumerator : object, IEnumerator {
                
                private ManagementObjectCollection.ManagementObjectEnumerator privObjEnum;
                
                public BcdDeviceElementEnumerator(ManagementObjectCollection.ManagementObjectEnumerator objEnum) {
                    this.privObjEnum = objEnum;
                }
                
                public virtual object Current {
                    get {
                        return new BcdDeviceElement(((ManagementObject)(this.privObjEnum.Current)));
                    }
                }
