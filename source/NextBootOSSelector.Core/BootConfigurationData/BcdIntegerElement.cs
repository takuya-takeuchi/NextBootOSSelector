...
namespace Ouranos.NextBootOSSelector.BootConfigurationData {
    ...
    // WMI クラス用に生成された事前バインディング クラスです。BcdIntegerElement
    internal class BcdIntegerElement : Component {
        ...
        private static string CreatedClassName = "BcdIntegerElement";
        ...
        public BcdIntegerElement() {
            this.InitializeObject(null, null, null);
        }
        
        public BcdIntegerElement(ManagementPath path, ObjectGetOptions getOptions) {
            this.InitializeObject(null, path, getOptions);
        }
        
        public BcdIntegerElement(ManagementScope mgmtScope, ManagementPath path) {
            this.InitializeObject(mgmtScope, path, null);
        }
        
        public BcdIntegerElement(ManagementPath path) {
            this.InitializeObject(null, path, null);
        }
        
        public BcdIntegerElement(ManagementScope mgmtScope, ManagementPath path, ObjectGetOptions getOptions) {
            this.InitializeObject(mgmtScope, path, getOptions);
        }
        
        public BcdIntegerElement(ManagementObject theObject) {
            this.Initialize();
        ...
        public BcdIntegerElement(ManagementBaseObject theObject) {
            this.Initialize();
            if (this.CheckIfProperClass(theObject)) {
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("This is the integer value of the element.")]
        ...
        public ulong Integer {
            get {
                ...
                return ((ulong)(this.curObj["Integer"]));
            }
            set {
                this.curObj["Integer"] = value;
                if (((this.isEmbedded == false) 
                            && this.AutoCommitProp)) {
        ...
        private bool ShouldSerializeInteger() {
            if ((this.IsIntegerNull == false)) {
                return true;
            }
            return false;
        }
        ...
        private static string ConstructPath() {
            string strPath = "root\\WMI:BcdIntegerElement";
            return strPath;
        }
        ...
        public static BcdIntegerElementCollection GetInstances() {
            return GetInstances(null, null, null);
        }
        
        public static BcdIntegerElementCollection GetInstances(string condition) {
            return GetInstances(null, condition, null);
        }
        
        public static BcdIntegerElementCollection GetInstances(string[] selectedProperties) {
            return GetInstances(null, null, selectedProperties);
        }
        
        public static BcdIntegerElementCollection GetInstances(string condition, string[] selectedProperties) {
            return GetInstances(null, condition, selectedProperties);
        }
        
        public static BcdIntegerElementCollection GetInstances(ManagementScope mgmtScope, EnumerationOptions enumOptions) {
            if ((mgmtScope == null)) {
            ...
            pathObj.ClassName = "BcdIntegerElement";
            ...
            return new BcdIntegerElementCollection(clsObject.GetInstances(enumOptions));
        }
        
        public static BcdIntegerElementCollection GetInstances(ManagementScope mgmtScope, string condition) {
            return GetInstances(mgmtScope, condition, null);
        }
        
        public static BcdIntegerElementCollection GetInstances(ManagementScope mgmtScope, string[] selectedProperties) {
            return GetInstances(mgmtScope, null, selectedProperties);
        }
        
        public static BcdIntegerElementCollection GetInstances(ManagementScope mgmtScope, string condition, string[] selectedProperties) {
            if ((mgmtScope == null)) {
                if ((statMgmtScope == null)) {
                    mgmtScope = new ManagementScope();
                    mgmtScope.Path.NamespacePath = "root\\WMI";
            ...
            ManagementObjectSearcher ObjectSearcher = new ManagementObjectSearcher(mgmtScope, new SelectQuery("BcdIntegerElement", condition, selectedProperties));
            EnumerationOptions enumOptions = new EnumerationOptions();
            enumOptions.EnsureLocatable = true;
            ObjectSearcher.Options = enumOptions;
            return new BcdIntegerElementCollection(ObjectSearcher.Get());
        }
        
        [Browsable(true)]
        public static BcdIntegerElement CreateInstance() {
            ...
            return new BcdIntegerElement(tmpMgmtClass.CreateInstance());
        }
        ...
        internal class BcdIntegerElementCollection : object, ICollection {
            
            private ManagementObjectCollection privColObj;
            
            public BcdIntegerElementCollection(ManagementObjectCollection objCollection) {
            ...
            public virtual void CopyTo(System.Array array, int index) {
                ...
                for (nCtr = 0; (nCtr < array.Length); nCtr = (nCtr + 1)) {
                    array.SetValue(new BcdIntegerElement(((ManagementObject)(array.GetValue(nCtr)))), nCtr);
                }
            }
            
            public virtual IEnumerator GetEnumerator() {
                return new BcdIntegerElementEnumerator(this.privColObj.GetEnumerator());
            }
            
            internal class BcdIntegerElementEnumerator : object, IEnumerator {
                
                private ManagementObjectCollection.ManagementObjectEnumerator privObjEnum;
                
                public BcdIntegerElementEnumerator(ManagementObjectCollection.ManagementObjectEnumerator objEnum) {
                    this.privObjEnum = objEnum;
                }
                
                public virtual object Current {
                    get {
                        return new BcdIntegerElement(((ManagementObject)(this.privObjEnum.Current)));
                    }
                }
