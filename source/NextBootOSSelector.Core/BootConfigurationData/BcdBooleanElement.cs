...
namespace Ouranos.NextBootOSSelector.BootConfigurationData {
    ...
    // WMI クラス用に生成された事前バインディング クラスです。BcdBooleanElement
    internal class BcdBooleanElement : Component {
        ...
        private static string CreatedClassName = "BcdBooleanElement";
        ...
        public BcdBooleanElement() {
            this.InitializeObject(null, null, null);
        }
        
        public BcdBooleanElement(ManagementPath path, ObjectGetOptions getOptions) {
            this.InitializeObject(null, path, getOptions);
        }
        
        public BcdBooleanElement(ManagementScope mgmtScope, ManagementPath path) {
            this.InitializeObject(mgmtScope, path, null);
        }
        
        public BcdBooleanElement(ManagementPath path) {
            this.InitializeObject(null, path, null);
        }
        
        public BcdBooleanElement(ManagementScope mgmtScope, ManagementPath path, ObjectGetOptions getOptions) {
            this.InitializeObject(mgmtScope, path, getOptions);
        }
        
        public BcdBooleanElement(ManagementObject theObject) {
            this.Initialize();
        ...
        public BcdBooleanElement(ManagementBaseObject theObject) {
            this.Initialize();
            if (this.CheckIfProperClass(theObject)) {
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("This is the boolean value of the element.")]
        ...
        public bool Boolean {
            get {
                ...
                return ((bool)(this.curObj["Boolean"]));
            }
            set {
                this.curObj["Boolean"] = value;
                if (((this.isEmbedded == false) 
                            && this.AutoCommitProp)) {
        ...
        private static string ConstructPath() {
            string strPath = "root\\WMI:BcdBooleanElement";
            return strPath;
        }
        ...
        public static BcdBooleanElementCollection GetInstances() {
            return GetInstances(null, null, null);
        }
        
        public static BcdBooleanElementCollection GetInstances(string condition) {
            return GetInstances(null, condition, null);
        }
        
        public static BcdBooleanElementCollection GetInstances(string[] selectedProperties) {
            return GetInstances(null, null, selectedProperties);
        }
        
        public static BcdBooleanElementCollection GetInstances(string condition, string[] selectedProperties) {
            return GetInstances(null, condition, selectedProperties);
        }
        
        public static BcdBooleanElementCollection GetInstances(ManagementScope mgmtScope, EnumerationOptions enumOptions) {
            if ((mgmtScope == null)) {
            ...
            pathObj.ClassName = "BcdBooleanElement";
            ...
            return new BcdBooleanElementCollection(clsObject.GetInstances(enumOptions));
        }
        
        public static BcdBooleanElementCollection GetInstances(ManagementScope mgmtScope, string condition) {
            return GetInstances(mgmtScope, condition, null);
        }
        
        public static BcdBooleanElementCollection GetInstances(ManagementScope mgmtScope, string[] selectedProperties) {
            return GetInstances(mgmtScope, null, selectedProperties);
        }
        
        public static BcdBooleanElementCollection GetInstances(ManagementScope mgmtScope, string condition, string[] selectedProperties) {
            if ((mgmtScope == null)) {
                if ((statMgmtScope == null)) {
                    mgmtScope = new ManagementScope();
                    mgmtScope.Path.NamespacePath = "root\\WMI";
            ...
            ManagementObjectSearcher ObjectSearcher = new ManagementObjectSearcher(mgmtScope, new SelectQuery("BcdBooleanElement", condition, selectedProperties));
            EnumerationOptions enumOptions = new EnumerationOptions();
            enumOptions.EnsureLocatable = true;
            ObjectSearcher.Options = enumOptions;
            return new BcdBooleanElementCollection(ObjectSearcher.Get());
        }
        
        [Browsable(true)]
        public static BcdBooleanElement CreateInstance() {
            ...
            return new BcdBooleanElement(tmpMgmtClass.CreateInstance());
        }
        ...
        internal class BcdBooleanElementCollection : object, ICollection {
            
            private ManagementObjectCollection privColObj;
            
            public BcdBooleanElementCollection(ManagementObjectCollection objCollection) {
            ...
            public virtual void CopyTo(System.Array array, int index) {
                ...
                for (nCtr = 0; (nCtr < array.Length); nCtr = (nCtr + 1)) {
                    array.SetValue(new BcdBooleanElement(((ManagementObject)(array.GetValue(nCtr)))), nCtr);
                }
            }
            
            public virtual IEnumerator GetEnumerator() {
                return new BcdBooleanElementEnumerator(this.privColObj.GetEnumerator());
            }
            
            internal class BcdBooleanElementEnumerator : object, IEnumerator {
                
                private ManagementObjectCollection.ManagementObjectEnumerator privObjEnum;
                
                public BcdBooleanElementEnumerator(ManagementObjectCollection.ManagementObjectEnumerator objEnum) {
                    this.privObjEnum = objEnum;
                }
                
                public virtual object Current {
                    get {
                        return new BcdBooleanElement(((ManagementObject)(this.privObjEnum.Current)));
                    }
                }
