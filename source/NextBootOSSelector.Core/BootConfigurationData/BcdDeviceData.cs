...
namespace Ouranos.NextBootOSSelector.BootConfigurationData {
    ...
    // WMI クラス用に生成された事前バインディング クラスです。BcdDeviceData
    internal class BcdDeviceData : Component {
        ...
        private static string CreatedClassName = "BcdDeviceData";
        ...
        public BcdDeviceData() {
            this.InitializeObject(null, null, null);
        }
        
        public BcdDeviceData(ManagementPath path, ObjectGetOptions getOptions) {
            this.InitializeObject(null, path, getOptions);
        }
        
        public BcdDeviceData(ManagementScope mgmtScope, ManagementPath path) {
            this.InitializeObject(mgmtScope, path, null);
        }
        
        public BcdDeviceData(ManagementPath path) {
            this.InitializeObject(null, path, null);
        }
        
        public BcdDeviceData(ManagementScope mgmtScope, ManagementPath path, ObjectGetOptions getOptions) {
            this.InitializeObject(mgmtScope, path, getOptions);
        }
        
        public BcdDeviceData(ManagementObject theObject) {
            this.Initialize();
        ...
        public BcdDeviceData(ManagementBaseObject theObject) {
            this.Initialize();
            if (this.CheckIfProperClass(theObject)) {
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("This represents the additional options for the element.")]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("This identifies the type of device element. This value dictates whether this is a" +
            " file device element or a partition device element.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        public DeviceTypeValues DeviceType {
            get {
                if ((this.curObj["DeviceType"] == null)) {
                    return ((DeviceTypeValues)(System.Convert.ToInt32(0)));
                }
                return ((DeviceTypeValues)(System.Convert.ToInt32(this.curObj["DeviceType"])));
            }
            set {
                if ((DeviceTypeValues.NULL_ENUM_VALUE == value)) {
        ...
        private static string ConstructPath() {
            string strPath = "root\\WMI:BcdDeviceData";
            return strPath;
        }
        ...
        public static BcdDeviceDataCollection GetInstances() {
            return GetInstances(null, null, null);
        }
        
        public static BcdDeviceDataCollection GetInstances(string condition) {
            return GetInstances(null, condition, null);
        }
        
        public static BcdDeviceDataCollection GetInstances(string[] selectedProperties) {
            return GetInstances(null, null, selectedProperties);
        }
        
        public static BcdDeviceDataCollection GetInstances(string condition, string[] selectedProperties) {
            return GetInstances(null, condition, selectedProperties);
        }
        
        public static BcdDeviceDataCollection GetInstances(ManagementScope mgmtScope, EnumerationOptions enumOptions) {
            if ((mgmtScope == null)) {
            ...
            pathObj.ClassName = "BcdDeviceData";
            ...
            return new BcdDeviceDataCollection(clsObject.GetInstances(enumOptions));
        }
        
        public static BcdDeviceDataCollection GetInstances(ManagementScope mgmtScope, string condition) {
            return GetInstances(mgmtScope, condition, null);
        }
        
        public static BcdDeviceDataCollection GetInstances(ManagementScope mgmtScope, string[] selectedProperties) {
            return GetInstances(mgmtScope, null, selectedProperties);
        }
        
        public static BcdDeviceDataCollection GetInstances(ManagementScope mgmtScope, string condition, string[] selectedProperties) {
            if ((mgmtScope == null)) {
                if ((statMgmtScope == null)) {
                    mgmtScope = new ManagementScope();
                    mgmtScope.Path.NamespacePath = "root\\WMI";
            ...
            ManagementObjectSearcher ObjectSearcher = new ManagementObjectSearcher(mgmtScope, new SelectQuery("BcdDeviceData", condition, selectedProperties));
            EnumerationOptions enumOptions = new EnumerationOptions();
            enumOptions.EnsureLocatable = true;
            ObjectSearcher.Options = enumOptions;
            return new BcdDeviceDataCollection(ObjectSearcher.Get());
        }
        
        [Browsable(true)]
        public static BcdDeviceData CreateInstance() {
            ...
            return new BcdDeviceData(tmpMgmtClass.CreateInstance());
        }
        ...
        internal class BcdDeviceDataCollection : object, ICollection {
            
            private ManagementObjectCollection privColObj;
            
            public BcdDeviceDataCollection(ManagementObjectCollection objCollection) {
            ...
            public virtual void CopyTo(System.Array array, int index) {
                ...
                for (nCtr = 0; (nCtr < array.Length); nCtr = (nCtr + 1)) {
                    array.SetValue(new BcdDeviceData(((ManagementObject)(array.GetValue(nCtr)))), nCtr);
                }
            }
            
            public virtual IEnumerator GetEnumerator() {
                return new BcdDeviceDataEnumerator(this.privColObj.GetEnumerator());
            }
            
            internal class BcdDeviceDataEnumerator : object, IEnumerator {
                
                private ManagementObjectCollection.ManagementObjectEnumerator privObjEnum;
                
                public BcdDeviceDataEnumerator(ManagementObjectCollection.ManagementObjectEnumerator objEnum) {
                    this.privObjEnum = objEnum;
                }
                
                public virtual object Current {
                    get {
                        return new BcdDeviceData(((ManagementObject)(this.privObjEnum.Current)));
                    }
                }
